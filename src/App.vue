<template>
    <div class="grid layout h-screen">
        <header
            class="border-b border-gray-300 py-4 text-xl px-6 font-semibold flex items-center justify-between"
        >
        ...
        <section
            class="sidebar sidebar-left border-r border-gray-300 overflow-hidden"
        >
