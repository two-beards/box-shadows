<template>
    ...
    ><code class="flex-1" :class="languageClass">{{ content }}</code>
        ...
        <button v-else @click="copyToClipboard" title="Copy to clipboard" class="bg-gray-50 text-gray-400 hover:text-gray-800 p-2 focus:outline-none focus:ring focus:ring-blue-600 rounded absolute right-1 inline-flex">
